...
export type NextStepKey = "creator" | "validator" | "lector" | "preview" | "publish";
export type StepId = "setup" | "generate" | "qa" | "preview" | "publish";
...
export type StudioView = "drafts" | "units" | "import";
