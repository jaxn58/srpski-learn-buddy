    ...
    <AnimatedPage className="md:[&_[data-slot=card-header]]:px-9 md:[&_[data-slot=card-content]]:px-9 md:[&_[data-slot=card-footer]]:px-9">
      ...
      <AnimatedItem className="max-md:!transform-none">
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid h-auto w-full grid-cols-3 gap-1 bg-muted p-1 md:grid-cols-6">
            <TabsTrigger value="overview" className="h-auto min-h-11 flex-none gap-1 whitespace-normal px-1.5 py-2 text-xs md:h-[calc(100%-1px)] md:min-h-0 md:flex-1 md:gap-2 md:whitespace-nowrap md:px-3 md:py-1 md:text-sm"><Lightbulb className="w-3.5 h-3.5 shrink-0 md:w-4 md:h-4"/> <span className="md:truncate">{tUnit("unit.tab.overview")}</span></TabsTrigger>
            <TabsTrigger value="vocabulary" className="h-auto min-h-11 flex-none gap-1 whitespace-normal px-1.5 py-2 text-xs md:h-[calc(100%-1px)] md:min-h-0 md:flex-1 md:gap-2 md:whitespace-nowrap md:px-3 md:py-1 md:text-sm"><BookOpen className="w-3.5 h-3.5 shrink-0 md:w-4 md:h-4"/> <span className="md:truncate">{tUnit("unit.tab.vocabulary")}</span></TabsTrigger>
            <TabsTrigger value="grammar" className="h-auto min-h-11 flex-none gap-1 whitespace-normal px-1.5 py-2 text-xs md:h-[calc(100%-1px)] md:min-h-0 md:flex-1 md:gap-2 md:whitespace-nowrap md:px-3 md:py-1 md:text-sm"><Brain className="w-3.5 h-3.5 shrink-0 md:w-4 md:h-4"/> <span className="md:truncate">{tUnit("unit.tab.grammar")}</span></TabsTrigger>
            <TabsTrigger value="phrases" className="h-auto min-h-11 flex-none gap-1 whitespace-normal px-1.5 py-2 text-xs md:h-[calc(100%-1px)] md:min-h-0 md:flex-1 md:gap-2 md:whitespace-nowrap md:px-3 md:py-1 md:text-sm"><MessageSquare className="w-3.5 h-3.5 shrink-0 md:w-4 md:h-4"/> <span className="md:truncate">{tUnit("unit.tab.phrases")}</span></TabsTrigger>
            <TabsTrigger value="dialogues" className="h-auto min-h-11 flex-none gap-1 whitespace-normal px-1.5 py-2 text-xs md:h-[calc(100%-1px)] md:min-h-0 md:flex-1 md:gap-2 md:whitespace-nowrap md:px-3 md:py-1 md:text-sm"><Mic className="w-3.5 h-3.5 shrink-0 md:w-4 md:h-4"/> <span className="md:truncate">{tUnit("unit.tab.dialogues")}</span></TabsTrigger>
            <TabsTrigger value="test" className="h-auto min-h-11 flex-none gap-1 whitespace-normal px-1.5 py-2 text-xs md:h-[calc(100%-1px)] md:min-h-0 md:flex-1 md:gap-2 md:whitespace-nowrap md:px-3 md:py-1 md:text-sm"><PenTool className="w-3.5 h-3.5 shrink-0 md:w-4 md:h-4"/> <span className="md:truncate">{tUnit("unit.tab.exercises")}</span></TabsTrigger>
          </TabsList>
