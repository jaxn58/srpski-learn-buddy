...
const VERIFIER_SYSTEM = [
  ...
  "",
  "CONSISTENCY: Your rulings must be internally consistent. If text X is acceptable, the equivalent text X in the next pass must also be acceptable. Do NOT oscillate between opposite recommendations on the same surface form.",
  "",
