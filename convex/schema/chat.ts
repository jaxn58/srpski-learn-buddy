...
export const chatTables = {
  ...
  // ============= KNOWLEDGE CHUNKS (RAG v3 -- Semantic Search) =============
  ...
  // ============= KNOWLEDGE ARTICLES (RAG v5 -- Admin Knowledge Base) =============
  ...
  // ============= USER DOCUMENTS (RAG v4 -- User Uploads) =============
  ...
  // ============= USER DOCUMENT CHUNKS (RAG v4 -- Embedded User Upload Chunks) =============
