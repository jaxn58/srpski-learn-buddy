/**
 * Replace Unit 3 vocabulary - Delete all existing and import new from Markdown file
 * 
 * Usage: npx tsx scripts/replace-unit3-vocabulary.ts
 */
...
/**
 * Parse markdown table and extract vocabulary words from Unit 3
 */
...
async function replaceUnit3Vocabulary() {
  console.log("🚀 Replacing Unit 3 Vocabulary...");
  ...
  // Step 1: Delete all existing Unit 3 vocabulary
  console.log("\n   Step 1: Deleting all existing Unit 3 vocabulary...");
  try {
  ...
  console.log(`\n📊 Total Unit 3 Vocabulary: ${allVocab.length} words`);
}

replaceUnit3Vocabulary().catch((error) => {
