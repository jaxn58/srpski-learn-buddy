/**
 * Replace Unit 4 vocabulary - Delete all existing and import new from Markdown file
 * 
 * Usage: npx tsx scripts/replace-unit4-vocabulary.ts
 */
...
/**
 * Parse markdown table and extract vocabulary words from Unit 4
 */
...
async function replaceUnit4Vocabulary() {
  console.log("🚀 Replacing Unit 4 Vocabulary...");
  ...
  // Step 1: Delete all existing Unit 4 vocabulary
  console.log("\n   Step 1: Deleting all existing Unit 4 vocabulary...");
  try {
  ...
  console.log(`\n📊 Total Unit 4 Vocabulary: ${allVocab.length} words`);
}

replaceUnit4Vocabulary().catch((error) => {
