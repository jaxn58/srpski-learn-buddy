...
<ul>
  <li><strong>Free access</strong> to the first 3 units of Module 1 during beta testing</li>
  <li><strong>50% OFF discount</strong> on the full course when we launch</li>
  <li>Early access to all features and improvements</li>
  <li>Direct impact on product development through your feedback</li>
</ul>

<h3>What's Included in Beta</h3>
<ul>
  <li>3 Units of structured Serbian lessons (Foundation Module)</li>
...
<p><strong>After Launch:</strong> Unlock all 27 units and 737+ vocabulary words with your exclusive 50% discount!</p>
...
<p>We've received your feedback and really appreciate you taking the time to help us improve Serbian AI Tutor!</p>
...
<p>Our team will review your feedback shortly. If it's a bug report, we'll investigate and fix it. For feature requests and improvements, we'll evaluate them for future updates.</p>
...
<p>Thank you for your interest in Serbian AI Tutor! We're excited that you want to join our waitlist for the upcoming Beta launch.</p>
...
<h3>What Happens Next?</h3>
<p>After confirming your email, you'll be added to our waitlist. We'll notify you as soon as the Beta is ready to launch!</p>
...
<h3>What's Next?</h3>
<p>We'll send you an email as soon as the Beta is ready to launch. You'll be among the first to know!</p>
...
<ul>
  ...
  <li>27 structured units covering beginner to intermediate Serbian</li>
  <li>737+ vocabulary words with audio pronunciations</li>
...
<p>Hvala (Thank you) for being part of our community!</p>
